        ...
        userForm: function() {
            ...
            if (c.append(p), a.agreement.isRequired) {
                ...
                r = a.agreement.sLink ? t("<a>").attr({
                    ...
                    class: "smart-basket__link-agreement"
                }), s.is(":checked") ? r.text("Наличные ") : r.text("Безналичным"), e.click(function() {
                    s.is(":checked") ? (r.text("Безналичным"), s.val("Я не принимаю условия пользовательского соглашения"), m.attr({
                        disabled: !1
                    }), d.addClass("")) : (r.text("Наличные "), s.val("Наличные "), m.attr({
                        disabled: !1
